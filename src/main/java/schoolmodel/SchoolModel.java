    ...
    //    System.out.println(SClass3.getId());
      ...
      //   sClasses.add(SClass5);
       ...
       // schoolControl.addClass(sclass);
        ...
        Instructor instructor3 = new Instructor( "Instructor", "a", date, Gender.NotKnown);
        Instructor instructor4 = new Instructor( "Instructor", "b", date, Gender.NotKnown);
